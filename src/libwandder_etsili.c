...
const uint8_t etsi_ipccoid[4] = {0x05, 0x03, 0x0a, 0x02};
const uint8_t etsi_ipirioid[4] = {0x05, 0x03, 0x0a, 0x01};
const uint8_t etsi_ipmmccoid[4] = {0x05, 0x05, 0x06, 0x02};
const uint8_t etsi_ipmmirioid[4] = {0x05, 0x05, 0x06, 0x01};
const uint8_t etsi_umtsirioid[9] =
