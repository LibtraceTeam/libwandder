...
enum {
    ...
    WANDDER_CLASS_ALREADY_ENCODED = 254,
...
enum {
    ...
    WANDDER_TAG_ULI=0x3a,
    WANDDER_TAG_ENCRYPTED=0x40,
    WANDDER_TAG_INTEGER_SEQUENCE=0x41,
    WANDDER_TAG_EPS_ATTACH_TYPE=0x42,
    WANDDER_TAG_EPS_RAT_TYPE=0x43,
    WANDDER_TAG_EPS_CAUSE=0x44,
    WANDDER_TAG_EPS_APN_AMBR=0x45,
    WANDDER_TAG_EPS_PDN_TYPE=0x46,
    WANDDER_TAG_ALREADY_ENCODED=0x47,
